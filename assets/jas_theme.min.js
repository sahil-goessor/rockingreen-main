        ...
        return {
            ...
            shopMasonry: function() {
                void 0 !== $.fn.isotope && void 0 !== $.fn.imagesLoaded && $(window).resize(function() {
                    $(".categories-masonry").each(function(t) {
                        var e = $(this)
                          , o = e.hasClass("categories-style-masonry") ? ".jas-item-category" : ".jas-col-md-3.jas-item-category";
                ...
                void 0 !== $.fn.isotope && void 0 !== $.fn.imagesLoaded && $(".jas-masonry").each(function(t, e) {
                    ...
                    if (void 0 !== o) {
                        ...
                        $(".jas-filter a").click(function() {
                            ...
                            !$(this).hasClass("selected") && (o.find(".selected").removeClass("selected"),
                ...
                var e = function(e, o, a, s) {
                    ...
                    $.ajax({
                        ...
                        complete: function() {
                            ...
                            if (gecko_settings.show_multiple_currencies && null !== o && Currency.convertAll(shopCurrency, o, ".jas-products-holder span.money"),
                            gecko_settings.productreviews && $(".spr-badge").length > 0)
                    ...
                    $(".jas_tta-container").each(function() {
                        ...
                        e.find(".products_tabs_ajax li").on("click", function(e) {
                            ...
                            t(i, c, s, a, o, n, function(t) {
                                ...
                                -1 != i.indexOf("sidetoshow_") ? geckoShopify.initCarousel() : geckoShopify.productsLoadMore()
                            })
                        })
                    });
                    var t = function(t, e, o, a, s, n, i) {
                        ...
                        $.ajax({
                            ...
                            complete: function() {
                                ...
                                if (gecko_settings.show_multiple_currencies && null !== t && Currency.convertAll(shopCurrency, t, ".type_jas_fea_coll_tab span.money"),
                                $(".spr-badge").length > 0 && gecko_settings.productreviews)
                                    return window.SPR.registerCallbacks(),
                                    window.SPR.initRatingHandler(),
                                    window.SPR.initDomEls(),
                                    window.SPR.loadProducts(),
            ...
            initDropdownMenu: function() {
                $("body").on("click", ".holderr", function(t) {
                    ...
                    e.find("li").removeClass("open")) : (e.addClass("open"),
                ...
                if ("no" != gecko_settings.header_sticky) {
                    ...
                    if (void 0 != gecko_settings && gecko_settings.header_sticky) {
                        ...
                        $(window).scroll(function() {
                            $(this).scrollTop() > a + 40 ? t.classList.add("header-sticky") : t.classList.remove("header-sticky")
                        })
                    }
                }
            },
            ...
            wcQuantityAdjust: function() {
                ...
                $(document).on("click", ".plus, .minus", function() {
                    ...
                    $(this).is(".plus") ? o && e >= o ? t.val(o) : t.val((e + parseFloat(s)).toFixed(s.getDecimals())) : a && e <= a ? t.val(a) : e > 0 && t.val((e - parseFloat(s)).toFixed(s.getDecimals())),
                    t.trigger("change")
                })
            },
            backToTop: function() {
                var t = $("#jas-backtop");
                $(window).scroll(function() {
                    $(this).scrollTop() > $(window).height() ? t.show() : t.hide()
                }),
                t.click(function() {
                            ...
                            $.magnificPopup.open({
                                ...
                                callbacks: {
                                    ...
                                    open: function() {
                                        ...
                                        var t = gl_Currency.cookie.read();
                                        if (gecko_settings.show_multiple_currencies && null !== t && Currency.convertAll(shopCurrency, t, ".product-quick-view span.money"),
                                        gecko_settings.productreviews && $(".spr-badge").length > 0)
                                            return window.SPR.registerCallbacks(),
                                            window.SPR.initRatingHandler(),
                                            window.SPR.initDomEls(),
            ...
            quickShop: function() {
                $(document).on("click", ".btn-quick-shop", function(t) {
                    ...
                    e.hasClass("btn-loading") || (o.hasClass("jas-qs-loaded") ? o.addClass("jas-qs-shown") : (e.addClass("btn-loading"),
                    o.addClass("loading-qs"),
                    $.ajax({
                        url: s,
                        dataType: "html",
                        type: "GET",
            ...
            catelog_mode: function() {
                if ($("body").hasClass("catalog_mode_on")) {
                    $("body");
                    var t = ['<div class="added-to-cart">', "<h3>" + gecko_settings.catelog_title + "</h3>", "<p>" + gecko_settings.catelog_info + "</p>", "<p>" + gecko_settings.catelog_info_2 + "</p>", '<a href="#" class="cate-close-popup button view-cart">' + gecko_settings.catelog_btn + "</a>", "</div>"].join("");
                    $.magnificPopup.open({
                        callbacks: {
                            beforeOpen: function() {
            ...
            loginWishlist: function() {
                gecko_settings.wishlist && $("body").on("click", ".nitro_wishlist_login", function(t) {
                    ...
                    var o = ['<div class="added-to-cart">', "<p>" + gecko_settings.info_wishlist + "</p>", '<a href="#" class="btn-style-link close-popup">' + gecko_settings.continue_shopping + "</a>", '<a href="/account/login" class="button view-cart">' + gecko_settings.login + "</a>", "</div>"].join("");
                    $.magnificPopup.open({
                        callbacks: {
                            beforeOpen: function() {
                                this.st.mainClass = geckoTheme.popupEffect + " cart-popup-wrapper"
                ...
                gecko_settings.wishlist && $("body").on("click", ".jas_add_wishlist > a", function(t) {
                    ...
                    $.ajax({
                        ...
                        success: function(t, e) {
                            ...
                            "success" == t.status && "success" == e ? (n.show(),
                            s.hide(),
                            a.hide(),
                ...
                gecko_settings.wishlist && $("body").on("click", ".remove_from_wishlist", function(t) {
                    ...
                    $.ajax({
                        ...
                        success: function(t, e) {
                            ...
                            "success" == t.status && "success" == e ? ($(".jas_count_wishlist").html(function(t, e) {
                                return 1 * e - 1
                            }),
                            $("#yith-wcwl-row-" + o).remove(),
                            $(".wishlist_table > tbody > tr").length < 1 && ($(".wishlist_table tbody").empty(),
                            $(".wishlist_table tbody").append('<tr><td colspan="6" class="wishlist-empty tc">' + gecko_settings.nowishlist + "</td>"))) : console.log("Error: " + t.message)
                        },
                        error: function(t) {
                            $(".loader").remove(),
                            console.log("Error: " + t.message)
                        ...
                        success: function(t) {
                          Shopify.getCart(function(cart){
                            $.get("/cart?view=json", function(t, e) {
                                ...
                                var o = gl_Currency.cookie.read();
                                gecko_settings.show_multiple_currencies && null !== o && (Currency.convertAll(shopCurrency, o, ".widget_shopping_cart_content span.money"),
                                Currency.convertAll(shopCurrency, o, ".gecko-cart-subtotal  span.money")),
            ...
            initAddToCart: function() {
                ...
                if ("popup" == gecko_settings.add_to_cart_action) {
                    var e = ['<div class="added-to-cart">', "<p>" + gecko_settings.added_to_cart + "</p>", '<a href="#" class="btn btn-style-link close-popup">' + gecko_settings.continue_shopping + "</a>", '<a href="/cart" class="button view-cart">' + gecko_settings.view_cart + "</a>", "</div>"].join("");
                    $.magnificPopup.open({
                        callbacks: {
                            beforeOpen: function() {
                                this.st.mainClass = geckoTheme.popupEffect + "  cart-popup-wrapper"
                    ...
                    "popup_upsell" == gecko_settings.add_to_cart_action ? $.ajax({
                    ...
                    }) : "no" == gecko_settings.add_to_cart_action ? document.location.href = "/cart" : (clearTimeout(t),
                    $(".jas-sidebar-cart").length > 0 ? ($("body").hasClass("open_gl_quick_view") && $.magnificPopup.close(),
                    $(".jas-sidebar-cart > a").trigger("click"),
                    window.Shopify && Shopify.StorefrontExpressButtons && gecko_settings.use_additional_checkout_buttons && Shopify.StorefrontExpressButtons.initialize()) : (console.log("bb"),
                    $("#jas-header .jas-icon-cart").addClass("display-widget"),
                    $("body").hasClass("open_gl_quick_view") && $.magnificPopup.close(),
                    $(window).scrollTop() > 100 && 0 == $("#jas-header").hasClass("header-sticky") && $("html, body").animate({
                        scrollTop: 0
                    }, 1e3),
                        ...
                        success: function(t) {
                          Shopify.getCart(function(cart){
                            $.get("/cart?view=json", function(t) {
                                ...
                                gecko_settings.show_multiple_currencies && null !== e && (Currency.convertAll(shopCurrency, e, ".widget_shopping_cart_content span.money"),
                                Currency.convertAll(shopCurrency, e, ".gecko-cart-subtotal  span.money")),
                                window.Shopify && Shopify.StorefrontExpressButtons && gecko_settings.use_additional_checkout_buttons && Shopify.StorefrontExpressButtons.initialize(),
            ...
            initMultiScroll: function() {
                geckoShopify.isMobile() || $(".jas-vertical-slide").each(function(t, e) {
                    ...
                    if (void 0 !== o) {
                        var a = o.speed ? o.speed : 700
                          , s = "true" == o.navigation
                          , n = o.navigationPosition ? o.navigationPosition : "left";
                        $(e).multiscroll({
                            scrollingSpeed: parseInt(a),
                            navigation: s,
            ...
            spInitSwitchLayout: function() {
                $("body").on("click", ".sp-col-switch a", function(t) {
                    ...
                    if (!e.hasClass("active")) {
                        ...
                        if (a.find("a").removeClass("active"),
                        e.addClass("active"),
                        s.hasClass("metro")) {
                            var p = i.not(".metro-item")
                              , u = s.find(".metro-item");
                            "3" == o || "2" == o ? (p.removeClass("jas-col-md-2 jas-col-md-3 jas-col-md-4 jas-col-md-6 jas-col-md-12 jas-col-md-15").addClass("jas-col-md-" + o),
                            u.removeClass("jas-col-md-2 jas-col-md-3 jas-col-md-4 jas-col-md-6 jas-col-md-12 jas-col-md-15").addClass("jas-col-md-6")) : i.removeClass("jas-col-md-2 jas-col-md-3 jas-col-md-4 jas-col-md-6 jas-col-md-12 jas-col-md-15").addClass("jas-col-md-" + o)
                        } else
                        ...
                        0 == r.length ? c.removeClass("lazyloaded").addClass("lazyload") : (geckoShopify.resizeElements(),
                        r.removeClass("lazyloaded").addClass("lazyload")),
            ...
            spAccordion: function() {
                $(".sp-accordions .tab-heading").click(function(t) {
                    ...
                    o.find(".entry-content").stop(!0, !0).slideUp()) : (a.find(".sp-accordion").removeClass("active"),
                    o.addClass("active"),
                    a.find(".entry-content").stop(!0, !0).slideUp(),
                    o.find(".entry-content").stop(!0, !0).slideDown())
                })
            },
            ...
            initCountdown: function() {
                $(".jas-countdown").each(function() {
                    $(this).countdown($(this).data("time"), {
                        ...
                        var e = $(this);
                        t.elapsed ? e.html("") : $(this).html(t.strftime('<div class="pr"><span class="db cw fs__16 mt__10">%-D</span><span class="db">' + gecko_settings.countdown_days + '</span></div><div class="pr"><span class="db cw fs__16 mt__10">%H</span><span class="db">' + gecko_settings.countdown_hours + '</span></div><div class="pr"><span class="db cw fs__16 mt__10">%M</span><span class="db">' + gecko_settings.countdown_mins + '</span></div><div class="pr"><span class="db cw fs__16 mt__10">%S</span><span class="db">' + gecko_settings.countdown_sec + "</span></div>"))
                    })
                })
            },
            ...
            initCountdown_page: function() {
                $(".jas_countdow_page").each(function() {
                    if ($(this).hasClass("jas_loop_bar")) {
                        ...
                        t > 0 ? $(this).countdown(geckoShopify.get1dayFromNow(t, e, o, a)).on("update.countdown", function(t) {
                            $(this);
                        ...
                        $(this).countdown($(this).data("time"), {
                            ...
                            var e = $(this);
                            t.elapsed ? e.html("") : $(this).html(t.strftime('<div class="block"><span class="flip-top">%-D</span><br><span class="label">' + gecko_settings.countdown_days_page + '</span></div><div class="block"><span class="flip-top">%H</span><br><span class="label">' + gecko_settings.countdown_hours_page + '</span></div><div class="block"><span class="flip-top">%M</span><br><span class="label">' + gecko_settings.countdown_mins_page + '</span></div><div class="block"><span class="flip-top">%S</span><br><span class="label">' + gecko_settings.countdown_sec_page + "</span></div>"))
                        })
                })
            },
            swatchesOnGrid: function() {
                $("body").on("click", ".jas_swatch_on_img:not(.current-swatch)", function() {
                    var t, e, o = $(this).data("src"), a = $(this).data("dtsrc"), s = $(this).data("srcset"), n = $(this).data("aspectratio");
                    if (void 0 !== o) {
                        ...
                        e = a,
                        s,
                        (t = o) != r && (i.addClass("loading-qs"),
                        c.attr("src", t).attr("data-src", e).attr("data-aspectratio", n).removeClass("lazyautosizes lazyloaded").addClass("lazyload lazypreload").removeClass("lazyautosizes lazyloaded").addClass("lazyload lazypreload").one("load", function() {
            ...
            swatchesOnBGGrid: function() {
                $("body").on("click", ".jas_swatch_on_bg:not(.current-swatch)", function() {
                    ...
                    e != s && (o.addClass("loading-image"),
                    a.attr("data-bgset", t).removeClass("lazyautosizes lazyloaded").addClass("lazyload lazypreload").imagesLoaded({
                        background: !0
                    }, function() {
            ...
            ajaxFilters: function() {
                if ($("body").hasClass("template-collection") || $("body").hasClass("ajax-shop-true")) {
                    ...
                    $(document).on("pjax:complete", function(o, a, s) {
                        ...
                        if (gecko_settings.show_multiple_currencies && null !== n && Currency.convertAll(shopCurrency, n, ".jas-products-holder span.money"),
                        t.shopPageInit(),
                        t.initCountdown(),
                        e(),
                        $("body").removeClass("gecko-loading"),
                        gecko_settings.productreviews && $(".shopify-product-reviews-badge").length > 0)
                            return window.SPR.registerCallbacks(),
                            window.SPR.initRatingHandler(),
                            window.SPR.initDomEls(),
                            window.SPR.loadProducts(),
            ...
            productImages: function() {
                var t, e = $(".shopify-product-gallery"), o = $(".single-product-thumbnail"), a = $(".p-thumb"), s = e, n = $(".photoswipe-images"), i = ".gecko-show-product-gallery";
                ...
                var c = function(t, e) {
                  ...
                  , r = function(t) {
                    return a.hasClass("jas-carousel") ? a.find(".slick-active").index() : $(t.currentTarget).parent().index()
                }
                  , l = function() {
                    var t = [];
            ...
            parallax: function() {
                if ($(window).width() <= 1024)
                    ...
                    $("[data-jas-parallax]").each(function() {
                        var t, o, a, s, n = $(this).attr("data-bgset"), i = $(this).attr("data-sizes"), c = $(this).attr("data-parent-fit");
                        e = !0,
                    ...
                    window.jasParallaxSkroll = skrollr.init(t),
            ...
            promoPopup: function() {
                ...
                if (!($("body").hasClass("catalog_mode_on") || "yes" != gecko_settings.enable_popup || 0 == $(".gecko-promo-popup ").length || "yes" == gecko_settings.promo_popup_hide_mobile && $(window).width() < 768)) {
                            ...
                            callbacks: {
                                ...
                                open: function() {
                                    $("#hideforever_ypop").change(function() {
                                        $(this).is(":checked") ? gecko_cookie("gecko_popup", "shown", {
                                            expires: 7,
                                            path: "/"
                                        }) : gecko_cookie("gecko_popup", null, {
                                            path: "/"
                                        })
                                    })
                                },
                    ...
                    "shown" != gecko_cookie("gecko_popup_" + t) && ("scroll" == gecko_settings.popup_event ? $(window).scroll(function() {
                        if (e)
                            return !1;
                        $(document).scrollTop() >= gecko_settings.popup_scroll && (a(),
                        e = !0)
                    }) : setTimeout(function() {
                        a()
            ...
            stickyFooter: function() {
                if ($("body").hasClass("footer_sticky") && !($(window).width() <= 1024)) {
                    $("body");
                    var t, e, o, a = $("#jas-footer"), s = a.find(".footer__top, .footer__bot"), n = a.outerHeight(), i = $("#jas-content"), c = $(document), r = $(window), l = c.outerHeight(), d = r.outerHeight(), p = function() {
                        i.css({
            ...
            simpleDropdown: function() {
                $(".input-dropdown-inner_pr").each(function() {
                    ...
                    a.on("click", function(a) {
                        ...
                        o.hasClass("dd-shown") ? e() : ($(".input-dropdown-inner_pr.dd-shown > ul").slideUp(100),
                    ...
                    n.on("click", "a", function(t) {
                        ...
                        0 != o ? n.find("li:first-child").show() : 0 == o && n.find("li:first-child").hide(),
                        a.text(i),
                        s.val(o),
                        e()
                    })
            ...
            simpleDropdown_qs: function() {
                $(".input-dropdown-inner_qs").each(function() {
                    ...
                    a.on("click", function(a) {
                        return a.preventDefault(),
                        o.hasClass("dd-shown") ? e() : ($(".input-dropdown-inner_qs.dd-shown > ul").slideUp(100),
            ...
            simpleDropdown_qv: function() {
                $(".input-dropdown-inner_qv").each(function() {
                    ...
                    a.on("click", function(a) {
                        return a.preventDefault(),
                        o.hasClass("dd-shown") ? e() : ($(".input-dropdown-inner_qv.dd-shown > ul").slideUp(100),
            ...
            fullHeightRow: function() {
                ...
                if (t.length) {
                    var e, o, a;
                    e = $(window).height(),
                    (o = t.offset().top) < e && (a = 100 - o / (e / 100),
                    t.css("min-height", a + "vh"))
                }
                $(document).trigger("jas-full-height-row", t)
            },
            jas_initVideoBackgrounds: function() {
                jQuery("[data-gl-video-bg]").each(function() {
                    var t, e, o = jQuery(this);
                    o.data("glVideoBg") ? (t = o.data("glVideoBg"),
                    (e = geckoShopify.jasExtractYoutubeId(t)) && (o.find(".jas_video-bg").remove(),
                    geckoShopify.insertYoutubeVideoAsBackground(o, e)),
            ...
            insertYoutubeVideoAsBackground: function(t, e, o) {
                if ("undefined" == typeof YT || void 0 === YT.Player)
                    return 100 < (o = void 0 === o ? 0 : o) ? void console.warn("Too many attempts to load YouTube api") : void setTimeout(function() {
            ...
            jasResizeVideoBackground: function(t) {
                var e, o, a, s, n = t.innerWidth(), i = t.innerHeight();
                n / i < 16 / 9 ? (e = i * (16 / 9),
                o = i,
                a = -Math.round((e - n) / 2) + "px",
                s = -Math.round((o - i) / 2) + "px",
                e += "px",
                o += "px") : (e = n,
                o = n * (9 / 16),
                s = -Math.round((o - i) / 2) + "px",
                ...
                e += "px",
                o += "px"),
                t.find(".jas_video-bg iframe").css({
                    maxWidth: "1000%",
                    marginLeft: a,
                    marginTop: s,
                    width: e,
                ...
                if (!($(window).width() <= 1024)) {
                    ...
                    var s = function(o) {
                        ...
                        var n = a.outerWidth()
                          ...
                          , l = $("body").hasClass("wrapper-boxed") || $("body").hasClass("wrapper-boxed-small") ? r : c;
                        if (n && i) {
                ...
                function t(t, e, o) {
                    ...
                    $.ajax({
                        ...
                        success: function(t) {
                            ...
                            "success" != t.result ? e.html('<div class="shopify-warning">' + a + "</div>").show(100) : e.html('<div class="shopify-message">' + a + "</div>").show(100)
                        }
                    })
                }
            ...
            favicon_counter: function(t) {
                "no" != gecko_settings.favicon_counter && new Favico({
            ...
            checkoutIndicator: function() {
                ...
                $("body").on("click", '[name="checkout"], [name="goto_pp"], [name="goto_gc"], .additional-checkout-buttons', function(t) {
                    if (console.log(!$(this).closest(".form_jas_agree").hasClass("jas_checkout")),
                    $(this).closest(".form_jas_agree").hasClass("jas_checkout")) {
                        if (!$(this).closest(".form_jas_agree").find(".jas_agree").is(":checked")) {
                            var e = ['<div class="added-to-cart">', "<p>" + gecko_settings.conditions + "</p>", "</div>"].join("");
            ...
            wcPopupAddtocart: function() {
                ...
                $("body").on("change", ".cart__popup-qty--input", function(e) {
                    ...
                    if (isNaN(s) || s < 0)
                        ...
                        s < n ? r = !0 : s % i != 0 ? (alert("Quantity can only be purchased in multiple of " + i),
                        r = !0) : t(a, s)
                    }
                    !0 === r && o.val(1)
                }),
                $("body").on("click", ".cart__popup-qty", function(e) {
                    ...
                    console.log(i),
                    console.log(n),
                    o.hasClass("cart__popup-qty--plus")) {
                        l = n + i;
                        if (console.log(l),
                        l > r && r > 0)
                            return a.val(r),
                    ...
                    $.ajax({
                        ...
                        success: function(t) {
                            jQuery.get("/cart?view=up_ajax", function(t) {}).always(function(t) {
                                ...
                                s > 0 ? $("#" + a + " input").val(s) : $(".cart__popup #" + a + " input").val(1),
...
jQuery(window).load(function() {
    jQuery(".jas-masonry").length > 0 && (jQuery(".jas-masonry").isotope("layout"),
    setTimeout(function() {
